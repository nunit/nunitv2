...
namespace NUnit.Core.Tests
{
	...
	public class NUnitTestCaseBuilderTests
	{
		...
		public IEnumerable TestsSource
		{
			get
			{
				yield return new object[] { Method("NonVoidTest"), RunState.NotRunnable };
			}
		}
		...
		public IEnumerable TestCasesSource
		{
			get
			{
				yield return new object[] { Method("VoidTestCaseWithExpectedResult"), RunState.NotRunnable };
			}
		}
		...
		public void Tests(MethodInfo method, RunState state)
		{
			...
			Assert.That(built, Is.InstanceOf<NUnitTestMethod>());
		...
		public void TestCases(MethodInfo method, RunState state)
		{
			...
			var testMethod = built.Tests[0] as NUnitTestMethod;
