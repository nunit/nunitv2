...
namespace NUnit.Framework
{
    ...
    /// </summary>
    public class LessEqualAsserter : ComparisonAsserter
    {
        /// <summary>
        ...
        public LessEqualAsserter(IComparable expected, IComparable actual, string message, params object[] args)
        ...
        {
            FailureMessage.WriteExpectedLine(string.Format("Value less than or equal to {0}", expected));
