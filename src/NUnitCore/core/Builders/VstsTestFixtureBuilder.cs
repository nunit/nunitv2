...
namespace NUnit.Core.Builders
{
	...
	/// </summary>
	public class VstsTestFixtureBuilder : AbstractFixtureBuilder
	{
        ...
        {
            return Reflect.HasAttribute(type, "Microsoft.VisualStudio.TestTools.UnitTesting.TestFixtureAtribute", true);
        }
        ...
        protected override bool IsRunnable(Type fixtureType, ref string reason)
        {
            Attribute ignoreAttribute =
                Reflect.GetAttribute(fixtureType, "Microsoft.VisualStudio.TestTools.UnitTesting.IgnoreAttribute", false);
        ...
        protected override bool IsValidFixtureType(Type fixtureType, ref string reason)
        {
            ...
            if (!CheckSetUpTearDownMethod(fixtureType, "Microsoft.VisualStudio.TestTools.UnitTesting.SetUpAttribute"))
            {
                reason = "Invalid SetUp method signature";
                return false;
            }

            if (!CheckSetUpTearDownMethod(fixtureType, "Microsoft.VisualStudio.TestTools.UnitTesting.TearDownAttribute"))
            {
                reason = "Invalid TearDown method signature";
                return false;
            }

            if (!CheckSetUpTearDownMethod(fixtureType, "Microsoft.VisualStudio.TestTools.UnitTesting.FixtureSetUpAttribute"))
            {
                reason = "Invalid TestFixtureSetUp method signature";
                return false;
            }

            if (!CheckSetUpTearDownMethod(fixtureType, "Microsoft.VisualStudio.TestTools.UnitTesting.FixtureTearDownAttribute"))
            {
        ...
        {
            //TODO: Fix this to use Description attribute
            Attribute fixtureAttribute =
                Reflect.GetAttribute(fixtureType, "Microsoft.VisualStudio.TestTools.UnitTesting.TestFixtureAttribute", true);
